...
# ltp model path
cws_model_path = os.path.abspath('./ltp_data_v3.4.0/cws.model')
pos_model_path = os.path.abspath('./ltp_data_v3.4.0/pos.model')
par_model_path = os.path.abspath('./ltp_data_v3.4.0/parser.model')
ner_model_path = os.path.abspath('./ltp_data_v3.4.0/ner.model')
